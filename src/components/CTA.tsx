    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            <Link to="/auth">
              <Button size="lg" className="text-base px-10 h-14 rounded-full bg-white text-background font-semibold hover:bg-white/90 shadow-[0_10px_40px_rgba(0,0,0,0.3)] gap-2">
